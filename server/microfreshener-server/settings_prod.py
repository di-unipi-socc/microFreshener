"""
Django settings for microfreshener-server project.
...
INSTALLED_APPS = [
    ...
    'api', # my REST api
     # TODO remove corsheader in prod env
    'corsheaders'
]
...
ROOT_URLCONF = 'microfreshener-server.urls'
...
WSGI_APPLICATION = 'microfreshener-server.wsgi.application'
